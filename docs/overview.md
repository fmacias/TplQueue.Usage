...
The same `samples` folder now also contains [PackageConsumptionSmokeConsole](../samples/PackageConsumptionSmokeConsole/README.md), a deliberately small release-smoke consumer that covers one checklist scenario per command without duplicating the detailed integration suite.
